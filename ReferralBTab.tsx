          ...
          <div className="relative z-10">
            ...
            {referralLink ? (
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-4 text-center">
                <h2 className="text-[18px] font-semibold text-white mb-2 leading-tight">Share the referral link</h2>
                <p className="text-blue-100 text-[15px] mb-4 leading-relaxed">Generate your referral link to start sharing with users.</p>

                <button
                  onClick={handleGenerateCode}
                  disabled={generatingCode}
                  className="w-full md:w-auto px-6 py-2.5 rounded-lg bg-white hover:bg-blue-50 text-blue-700 text-[15px] font-semibold transition-all inline-flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {generatingCode ? (
                    <>
