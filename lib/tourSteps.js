...
const tourSteps = [
  {
    ...
    content: "Ask any clinical question here. Add details for more precise answers",
    disableBeacon: true,
  },
  {
    target: ".dashboard-acute-toggle", // Acute mode toggle
    content: "Toggle Acute Mode for acute care type questions. Example: 'How to treat a hypertensive emergency?'",
  },
  {
...
export const drinfoSummaryTourSteps = [
  {
    ...
    content: "Here's your AI-powered answer. Dr.Info turns complex medical literature into clear, specialty-specific insights — saving time, reducing cognitive load, and delivering evidence-based precision",
    disableBeacon: true,
  ...
  },
  {
    ...
    content: "Need more detail? Use the follow-up field to clarify, add context, or go deeper — Dr.Info will refine the answer for you.",
    disableScrolling: true, // Disable scrolling for this step
